...
if __name__ == '__main__':
    try:
        ...
        table_definition = TableDefinition(
            table_name="orders",
            columns=[
                TableDefinition.Column("source_id", SqlType.big_int()),
                TableDefinition.Column("gas", SqlType.text()),
                TableDefinition.Column("emissions_quantity_ton", SqlType.double()),
                TableDefinition.Column("emissions_factor_ton", SqlType.double()),
                TableDefinition.Column("capacity_ha", SqlType.double()),
                TableDefinition.Column("capacity_factor", SqlType.double()),
                TableDefinition.Column("activity_ha", SqlType.double()),
                TableDefinition.Column("sector", SqlType.text()),
                TableDefinition.Column("subsector", SqlType.text()),
                TableDefinition.Column("country_name", SqlType.text()),
                ...
                TableDefinition.Column("quarter", SqlType.int()),
                TableDefinition.Column("month", SqlType.big_int()),
                TableDefinition.Column("start_date", SqlType.timestamp_tz()),
                TableDefinition.Column("end_date", SqlType.timestamp_tz()),
            ]
        )

        run_create_hyper_file_from_parquet(
            "../cleaned_data/merged_climate_data.parquet",
            table_definition,
            "../cleaned_data/merged_climate_data.hyper")
