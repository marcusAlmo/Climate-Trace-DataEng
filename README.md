...
## 📋 Overview
This project is a comprehensive data engineering pipeline for processing and analyzing climate trace data. It's designed to handle large-scale environmental datasets from Climate Trace, focusing on greenhouse gas emissions (CO₂, CH₄, N₂O) and their CO₂ equivalents across the years 2021-2024.
